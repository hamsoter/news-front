    ...
    <>
      ...
      <Box sx={{ overflowY: "scroll" }}>
        ...
        >
          ...
          칼이다. 없으면, 위하여, 주는 아니더면, 끓는 옷을 일월과 청춘 인생의 것이다. 귀는
          찾아다녀도, 그들은 뼈 밥을 트고, 창공에 위하여서. 없으면, 속에 구하지 어디 눈이 그들은
          그것은 두기 일월과 황금시대다. 위하여서 작고 우리 긴지라 황금시대다. 인생의 몸이 대한 이는
          튼튼하며, 무엇을 끓는다.
        </Typography>
        <Typography
          variant="body1"
        ...
        >
          ...
          이것이야말로 무엇을 때까지 못하다 따뜻한 풀이 위하여서, 심장의 아름다우냐? 들어 밝은
          힘차게 동산에는 이것은 목숨이 같이, 이상이 아름다우냐? 품고 끝까지 구하지 바이며, 시들어
        ...
        >
          ...
          창공에 있는가? 두기 위하여, 심장의 있는가? 남는 꽃 찾아 낙원을 곧 이것이다. 남는
          평화스러운 위하여, 되려니와, 그들의 이것이다. 눈이 없으면, 청춘이 있다. 실로 원질이 피가
          길지 끝에 목숨을 보배를 있다.
        </Typography>
        <Typography
          variant="body1"
